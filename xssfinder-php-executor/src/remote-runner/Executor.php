...
include_once $GLOBALS['THRIFT_ROOT'].'/packages/remote-runner/remote-runner_types.php';
...
interface ExecutorIf {
  ...
  public function traverseMethod($method, $mode);
...
class ExecutorClient implements \XssFinderRemote\ExecutorIf {
  ...
  public function send_traverseMethod($method, $mode)
  {
