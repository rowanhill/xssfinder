...
interface ExecutorIf {
  ...
  public function traverseMethod(\XssFinder\MethodDefinition $method, $mode);
  public function invokeAfterRouteHandler($rootPageIdentifier);
}

class ExecutorClient implements \XssFinder\ExecutorIf {
  ...
  public function recv_getPageDefinitions()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_getPageDefinitions_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_startRoute_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_putXssAttackStringsInInputs_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_getCurrentXssIds_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_getFormCount_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_traverseMethod(\XssFinder\MethodDefinition $method, $mode)
  {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_traverseMethod_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\XssFinder\Executor_invokeAfterRouteHandler_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\XssFinder\PageDefinition',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            {
              $elem13 = null;
              $elem13 = new \XssFinder\PageDefinition();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'webInteraction',
          'type' => TType::STRUCT,
          'class' => '\XssFinder\TWebInteractionException',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->webInteraction = new \XssFinder\TWebInteractionException();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'method',
          'type' => TType::STRUCT,
          'class' => '\XssFinder\MethodDefinition',
          ),
        2 => array(
          'var' => 'mode',
          'type' => TType::I32,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->method = new \XssFinder\MethodDefinition();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'untraversable',
          'type' => TType::STRUCT,
          'class' => '\XssFinder\TUntraversableException',
          ),
        2 => array(
          'var' => 'webInteraction',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->untraversable = new \XssFinder\TUntraversableException();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\XssFinder\TLifecycleEventHandlerException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->lifecycleEventHandler = new \XssFinder\TLifecycleEventHandlerException();
